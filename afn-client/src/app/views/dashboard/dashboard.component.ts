...
export class DashboardComponent implements OnInit {
  ...
  public pieChartLabels1: Label[] = ["Male" , "Female"];
  public pieChartData1: number[] = [40, 35];
  public pieChartType1: ChartType = "pie";
  public pieChartLegend1 = true;
  //public pieChartPlugins = [pluginDataLabels];
  public pieChartColors1 = [
    {
      backgroundColor: ["rgb(32, 168, 216)", "rgb(248, 108, 107)"],
    },
  ];
  ...
  public pieChartLabels2: Label[] = ["18 < Age ", "18 < Age < 3 ", "30 < Age "];
  public pieChartData2: number[] = [3, 46, 12];
  public pieChartType2: ChartType = "pie";
  public pieChartLegend2 = true;
  //public pieChartPlugins = [pluginDataLabels];
  public pieChartColors2 = [
    {
      backgroundColor: ["rgb(77, 189, 116)", "rgb(99, 194, 222)", "rgb(255, 193, 7)"],
    },
  ];
}
